...
|---|----------|------|------|---------|--------------|
| ~~1~~ | ~~ICH E6(R3) Step 4 최종본 전문~~ | ICH | ✅ **완료 (2026-04-14)**: PDF 전문 MD 변환 완료. 전체 10개 섹션 파일이 `ich/e6_r3_full/`에 수록됨. Appendix B(B.1-B.16) 16개 공식 섹션 확인, Glossary 전체 수록, Principles 11개 원칙 원문 확보 | `ich/e6_r3_full/` (10개 파일) | — |
| 2 | ICH E8(R1) Step 4 최종본 전문 | ICH | PDF가 이미지 기반으로 텍스트 추출 불가. Section 7 CtQ 요소 전체 목록(18개) 원문 확인 필요 | `ich/ich_e8_r1.md` | Section 7 CtQ 요소 전체 목록 원문, 각 섹션 세부 내용. **참고**: E6(R3)와 같은 방식(PDF 파일 제공 + `pdftotext` 추출)으로 보강 가능 |
