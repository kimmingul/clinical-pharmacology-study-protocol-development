...
Agent(
  ...
  prompt: "먼저 ${CLAUDE_PLUGIN_ROOT}/agents/clinical-pharmacologist.md를 Read하라.
${CLAUDE_PLUGIN_ROOT}/skills/regulatory-review/SKILL.md를 Read하여 리뷰 절차를 따르라.
...
Agent(
  ...
  prompt: "먼저 ${CLAUDE_PLUGIN_ROOT}/agents/regulatory-expert.md를 Read하라.
${CLAUDE_PLUGIN_ROOT}/skills/regulatory-review/SKILL.md를 Read하여 리뷰 절차를 따르라.
...
Agent(
  ...
  prompt: "먼저 ${CLAUDE_PLUGIN_ROOT}/agents/biostatistician.md를 Read하라.
${CLAUDE_PLUGIN_ROOT}/skills/regulatory-review/SKILL.md를 Read하여 리뷰 절차를 따르라.
...
Agent(
  ...
  model: "opus",
  name: "clinician",
  prompt: "먼저 ${CLAUDE_PLUGIN_ROOT}/agents/clinician.md를 Read하라.
${CLAUDE_PLUGIN_ROOT}/skills/regulatory-review/SKILL.md를 Read하여 리뷰 절차를 따르라.
...
Agent(
  ...
  prompt: "먼저 ${CLAUDE_PLUGIN_ROOT}/agents/translational-scientist.md를 Read하라.
${CLAUDE_PLUGIN_ROOT}/skills/regulatory-review/SKILL.md를 Read하여 리뷰 절차를 따르라.
...
$PY ${CLAUDE_PLUGIN_ROOT}/scripts/llm/review_panel.py plan --routing "$WS/llm/routing_plan.json" \
...
${CLAUDE_PLUGIN_ROOT}/scripts/llm/run_review_panel.sh --workspace "$WS" --host "$HOST" $CLASS \
...
Agent(
  ...
  model: "opus",
  name: "qa-reviewer",
  prompt: "먼저 ${CLAUDE_PLUGIN_ROOT}/agents/qa-reviewer.md를 Read하라.
${CLAUDE_PLUGIN_ROOT}/skills/regulatory-review/SKILL.md를 Read하여 QA 절차를 따르라.
