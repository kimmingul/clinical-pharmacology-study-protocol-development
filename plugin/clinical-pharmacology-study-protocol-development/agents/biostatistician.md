...
- `${CLAUDE_PLUGIN_ROOT}/scripts/sample_size/` 내 사전 검증된 Python 코드 템플릿을 Read하여 활용한다
...
`${CLAUDE_PLUGIN_ROOT}/scripts/sample_size/` 디렉토리의 스크립트를 Read하여 파라미터를 채운다:
...
- `${CLAUDE_PLUGIN_ROOT}/scripts/sample_size/williams_6x3_ddi.py` 사용
